...
- The dollars came from somewhere real — your accounts. That "somewhere" was Ready to Work, drawn against your future income.
...
By June 1, *Groceries* shows $0 carry-in. You assign fresh from a Ready to Work that's $30 lighter than it would have been.
...
You can't change the rule per-category. If you want a category to *not* accumulate (a *Fun money* envelope where leftover should refund to Ready to Work at month-end), do it manually: at month-end, move the surplus from *Fun money* back to a savings category or directly into next month by editing next month's Assigned.
