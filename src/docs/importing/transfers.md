...
If you leave them that way, [Ready to Work](/glossary/#ready-to-assign) overstates your income, [Spending by category](/docs/reports/spending/) shows phantom outflows, and the [Net worth](/docs/reports/net-worth/) line is unaffected (because the two sides cancel) but every other report lies.
