...
1. Cover this month's bills first (Immediate Obligations).
2. Slice off the monthly share of True Expenses (annual ÷ 12).
...
Once you have a month or two of history, [Auto-assign](/docs/envelope-budget/auto-assign/) can pre-fill the column from last month's spending, a rolling average, or your goal needs. The first month is the only one you'll do entirely by hand.

## 5. Set goals where they help

Goals turn fuzzy intentions into specific monthly targets. See [Goals](/docs/envelope-budget/goals/) for the four types and when each fits.
...
Money flows daily. The [register](/docs/accounts/register-and-entry/) is where every transaction lands.
